...
`meridian-trade-auction-hub` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for auction systems, covering visual model generation, layout fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 166. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 5.
