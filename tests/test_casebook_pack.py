"""Regression checks for the meridian-trade-auction-hub casebook."""
...
from casebook.harness import assert_expected, meridian_trade_auction_hub_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_trade_auction_hub_summary(), assert_expected())
